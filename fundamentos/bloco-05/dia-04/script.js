...
window.onload = function () {
  ...
  for (i = 0; i < backgroundColorButtons.length; i += 1) {
  ...
  for (i = 0; i < fontColorButtons.length; i += 1) {
  ...
  for (i = 0; i < fontSizeButtons.length; i += 1) {
  ...
  for (i = 0; i < lineHeightButtons.length; i += 1) {
  ...
  for (i = 0; i < fontFamilyButtons.length; i += 1) {
